...
@section('content')
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="locataires_id" class="form-control" id="locataireSelect">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="maisons_id" class="form-control" id="maisonsSelect">
                                                            ...
                                                            @foreach ($maisons as $item)
                                                                <option value="{{ $item->id }}"
                                                                    data-loyer="{{ $item->loyer }}"
                                                                    data-immeuble="{{ $item->immeuble->code }} - {{ $item->immeuble->adresse }}"
                                                                    data-type="{{ $item->type_maison }}"
                                                                    data-adresse="{{ $item->adresse }}">
                                                                    {{ $item->id }} - {{ $item->type_maison }} -
                                                                    {{ $item->loyer }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
    ...
    <script>
        document.getElementById('locataireSelect').addEventListener('change', function() {
            var selectedOption = this.options[this.selectedIndex];
